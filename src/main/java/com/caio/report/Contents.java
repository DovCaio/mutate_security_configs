...
public class Contents {
    ...
    public static String html(List<TestResult> testResults) {

        int totalMutants = testResults.size();
        long capturedCount = testResults.stream().filter(TestResult::wasCaptured).count();
        ...
        for (TestResult result : testResults) {
            boolean captured = result.wasCaptured();
            ...
            html.append(String.format("""
                    ...
                    """, rowClass, index++, params.packageName, params.method.equals("") ? "Classe" : "Método",
                    params.className, params.method,
